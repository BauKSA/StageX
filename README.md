...
## 🛠️ Stack Tecnológico
* **Lenguaje:** C++17.
* **Librería Multimedia:** SFML (Simple and Fast Multimedia Library).

## ⚙️ Características
- Sistema de disparo y colisiones optimizado.
- Estética arcade clásica.
- Assets de fácil acceso (sprites editables para la comunidad).
- Ejecutable ligero y estable.

## 🚀 Cómo compilar (Desarrollo)
Si tenés configurado un entorno de C++ con SFML:
